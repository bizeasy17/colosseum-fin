    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weibo_account', models.URLField(blank=True, max_length=255, null=True, verbose_name='Weibo profile')),
                ('weixin_account', models.URLField(blank=True, max_length=255, null=True, verbose_name='Weixin profile')),
                ('qq_account', models.URLField(blank=True, max_length=255, null=True, verbose_name='QQ profile')),
