...
class User(AbstractUser):
    ...
    weibo_account = models.URLField(
        _('Weibo profile'), max_length=255, blank=True, null=True)
    weixin_account = models.URLField(
        _('Weixin profile'), max_length=255, blank=True, null=True)
    qq_account = models.URLField(
        _('QQ profile'), max_length=255, blank=True, null=True)
